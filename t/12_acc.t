...
is ($csv.skip-empty-rows,       0,     "skip-empty-rows");
...
is ($csv.auto_diag (""),               False, "auto_diag (\"\")");
is ($csv.strict (1),                   True,  "strict (1)");
is ($csv.strict (True),                True,  "strict (True)");
is ($csv.strict (False),               False, "strict (False)");
is ($csv.strict (Str),                 False, "strict (Str)");
is ($csv.strict (""),                  False, "strict (\"\")");
...
is ($csv.skip_empty_rows (True),       1,     "skip_empty_rows (True)");
is ($csv.skip_empty_rows ("1"),        1,     "skip_empty_rows ('1')");
is ($csv.skip_empty_rows (1),          1,     "skip_empty_rows (1)");
is ($csv.skip_empty_rows ("stop"),     2,     "skip_empty_rows (True)");
is ($csv.skip_empty_rows ("EOF"),      2,     "skip_empty_rows ('EOF')");
is ($csv.skip_empty_rows ("2"),        2,     "skip_empty_rows ('2')");
is ($csv.skip_empty_rows (2),          2,     "skip_empty_rows (2)");
is ($csv.skip_empty_rows ("die"),      3,     "skip_empty_rows ('die')");
is ($csv.skip_empty_rows ("3"),        3,     "skip_empty_rows ('3')");
is ($csv.skip_empty_rows (3),          3,     "skip_empty_rows (3)");
is ($csv.skip_empty_rows ("croak"),    4,     "skip_empty_rows ('croak')");
is ($csv.skip_empty_rows ("4"),        4,     "skip_empty_rows ('4')");
is ($csv.skip_empty_rows (4),          4,     "skip_empty_rows (4)");
is ($csv.skip_empty_rows ({ 1 }),      5,     "skip_empty_rows (CB)");
is ($csv.escape_char ("\\"),           "\\",  "escape_char (\\)");
ok ($csv.combine (@fld),                      "combine");
...
is ($csv.skip_empty_rows (False),  0,     "skip_empty_rows (False)");
is ($csv.skip_empty_rows (0),      0,     "skip_empty_rows (0)");
is ($csv.sep ("--"),               "--",  "sep (\"--\")");
is ($csv.sep_char (),              "--",  "sep_char");
