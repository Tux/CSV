...
WORK IN PROGRESS. Default is True.
...
X<blank-is-undef>
 ...
 my $csv = Text::CSV.new(blank_is_undef => True);
...
X<empty_is_undef>
 ...
 my $csv = Text::CSV.new(empty_is_undef => True);
...
X<allow_whitespace>
 ...
 my $csv = Text::CSV.new(allow_whitespace => True);
...
X<allow_loose_quotes>
 ...
 my $csv = Text::CSV.new(allow_loose_quotes => True);
...
X<allow_loose_escapes>
 ...
 my $csv = Text::CSV.new(allow_loose_escapes => True);
...
X<allow_unquoted_escape>
 ...
 my $csv = Text::CSV.new(allow_unquoted_escape => True);
...
X<always_quote>
 ...
 my $csv = Text::CSV.new(always_quote => True);
...
X<quote_null>
 ...
 my $csv = Text::CSV.new(quote_null => True);
...
X<quote_binary>
 ...
 my $csv = Text::CSV.new(quote_binary => True);
...
X<keep-meta>
 ...
 my $csv = Text::CSV.new(keep_meta => True);
         $csv.keep_meta(False);
...
=head2 Reading a CSV file line by line:
 ...
 my $csv = Text::CSV.new(auto_diag => True);
