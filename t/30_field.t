...
$f.text      = "=1+2";            # "=1+2"
$f.analyse (True);
is (?$f,          True,           "'=1+2' in Boolean context");
$n = +$f;
is ($n.^name,     "Failure",      "'=1+2' in Numeric context type");
is ($n.defined,   False,          "'=1+2' in Numeric context defined");
$s = ~$f;
is ($s.^name,     "Str",          "'=1+2' in String  context type");
is ($s.defined,   True,           "'=1+2' in String  context defined");
is ($s,           "=1+2",         "'=1+2' in String  context value");
is ($f.gist,      'Qb7m=:"=1+2"', "'=1+2' as gist");
