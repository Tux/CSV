...
If C<$colref> is undefined (explicit,  not through a variable argument) and
...
array ref is returned by the function or C<Array> for failure.  When C<$io>
