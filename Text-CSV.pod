...
will print
 ...
 EIF - Loose unescaped quote : error 2034 @ record 1, position 2
  "?",
...
All of the 5 items can be retrieved as a list or positional:
...
All of the 5 items can be retrieved as a hash entry
