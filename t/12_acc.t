...
is ($csv.skip_empty_rows,       False, "skip_empty_rows");
is ($csv.skip-empty-rows,       False, "skip-empty-rows");
...
is ($csv.skip_empty_rows (True),       True,  "skip_empty_rows (True)");
is ($csv.skip_empty_rows (1),          True,  "skip_empty_rows (1)");
is ($csv.escape_char ("\\"),           "\\",  "escape_char (\\)");
ok ($csv.combine (@fld),                      "combine");
...
is ($csv.skip_empty_lines (False), False, "skip_empty_lines (False)");
is ($csv.skip_empty_lines (0),     False, "skip_empty_lines (0)");
is ($csv.sep ("--"),               "--",  "sep (\"--\")");
is ($csv.sep_char (),              "--",  "sep_char");
