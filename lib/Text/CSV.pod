...
=item Channel
 ...
 my $aoa = csv(in => $in, out => $ch);
 await $pr;

Writes the data rows into the Channel.
...
Provide all supported types of input also for output: Supply, Channel,
Callable, ...
